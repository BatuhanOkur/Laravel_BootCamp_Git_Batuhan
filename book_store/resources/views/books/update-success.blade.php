...
<div class="card" style="width: 85%; margin-top: 10%; margin-left: 10%; text-align: center;">
    ...
    <div class="card-body">
        <h5 class="card-title">Kitap güncellemesi başarılı!</h5>
        <p class="card-text">"{{$book->name}}" isimli kitap için girdiğiniz bilgiler başarıyla güncellendi.</p>
        <a href="/kitapliste" class="btn btn-success">Kitap listesine geri dön.</a>
    </div>
</div>
