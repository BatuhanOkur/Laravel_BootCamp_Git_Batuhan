...
<div class="input-group" style="margin-left: 45%; margin-top: 20%; margin-bottom: 20%;">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-signin" action="/kitapkaydet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="updated_by" id="updated_by" placeholder="Type here last updater(for database)...">
                </div>
                @csrf
